...
function draw() {
  ...
  if(gamestate===1){
    textSize(50)
    fill ("black")
    text("To Start The Game Press 'SPACE'",83,83)
    textSize(43)
    text ("Press The Arrow Keys To MoveIn The Game",13,180)
    text ("'THE BACKSTORY'",233,280)
    text ("You are on a top secret mission, In which you have to,",20,340)
    text
    text ("steal expensive goods from mystery manor but be a bit",20,420)
if(keyDown("space")){
  gamestate=2
}
  } 
